...
func main() {
	...
	// The file name starts with the prefix given as the second argument to os.CreateTemp and
	// the rest is chosen automatically to ensure that concurrent calls will always create different file names.
	...
	err = os.WriteFile(fname, []byte{1, 2, 3, 123}, 0666)
	check(err)
