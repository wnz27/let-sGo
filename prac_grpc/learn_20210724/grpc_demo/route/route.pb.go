...
type Rectangle struct {
	...
	Li *Point `protobuf:"bytes,2,opt,name=li,proto3" json:"li,omitempty"`
}
...
var file_route_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x50, 0x6f, 0x69, 0x6e, 0x74, 0x52, 0x02, 0x6c, 0x6f, 0x12, 0x1c, 0x0a, 0x02, 0x6c,
	0x69, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x2e,
	0x50, 0x6f, 0x69, 0x6e, 0x74, 0x52, 0x02, 0x6c, 0x69, 0x22, 0x6e, 0x0a, 0x0c, 0x52, 0x6f, 0x75,
	...
	0x61, 0x70, 0x73, 0x65, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x6a, 0x0a, 0x15, 0x72, 0x65, 0x63,
	...
	0x09, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x47, 0x75, 0x69, 0x64, 0x12, 0x2c, 0x0a, 0x0a, 0x47, 0x65,
	...
	0x64, 0x12, 0x1c, 0x2e, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x2e, 0x72, 0x65, 0x63, 0x6f, 0x6d, 0x6d,
	...
	0x00, 0x28, 0x01, 0x30, 0x01, 0x42, 0x1b, 0x5a, 0x19, 0x66, 0x7a, 0x6b, 0x70, 0x72, 0x61, 0x63,
	0x2f, 0x32, 0x30, 0x32, 0x31, 0x30, 0x37, 0x32, 0x34, 0x2f, 0x72, 0x70, 0x63, 0x5f, 0x64, 0x65,
...
var file_route_proto_goTypes = []interface{}{
	...
	(*Rectangle)(nil),             // 3: route.Rectangle
...
var file_route_proto_depIdxs = []int32{
	1, // 0: route.Feature.location:type_name -> route.Point
	1, // 1: route.Rectangle.lo:type_name -> route.Point
	1, // 2: route.Rectangle.li:type_name -> route.Point
	...
	1, // 5: route.RouteGuid.GetFeature:input_type -> route.Point
	3, // 6: route.RouteGuid.ListFeatures:input_type -> route.Rectangle
	1, // 7: route.RouteGuid.RecordRoute:input_type -> route.Point
	5, // 8: route.RouteGuid.Recommend:input_type -> route.recommendationRequest
	2, // 9: route.RouteGuid.GetFeature:output_type -> route.Feature
	2, // 10: route.RouteGuid.ListFeatures:output_type -> route.Feature
	4, // 11: route.RouteGuid.RecordRoute:output_type -> route.RouteSummary
	2, // 12: route.RouteGuid.Recommend:output_type -> route.Feature
