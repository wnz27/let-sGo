...
```
最后我们创建一个外层的main函数来调用中间层。这是我们程序面向用户的部分：
```go
...
```
[【完整demo】](err_demo/err_demo.go)

我们会得到如下日志信息：
```shell
[logID: 1]: 
12:44:28 main.LowLevelErr{error:main.MyError{Inner:(*fs.PathError)(0xc000098180), 
Message:"stat /bad/job/binary: no such file or directory", 
StackTrace:"goroutine 1 [running]:
runtime/debug.Stack(0xc0000ac030, 0x2f, 0x0)
  /Users/fzk27/.go/go1.16.6/src/runtime/debug/stack.go:24 +0x9f
main.wrapError(0x1102150, 0xc000098180, 0xc0000ac030, 0x2f, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, ...)
  /Users/fzk27/fzk27/let-sGo/related_book_learn/Concurrency_in_go/chapter5/error_pass/err_demo/err_demo.go:30 +0xb4
main.isGloballyExec(0x10e0be8, 0xf, 0x4, 0x1005ecb, 0xc000054058)
  /Users/fzk27/fzk27/let-sGo/related_book_learn/Concurrency_in_go/chapter5/error_pass/err_demo/err_demo.go:48 +0xc5
main.runJob(0x10df2a8, 0x1, 0x1018301, 0x0)
  /Users/fzk27/fzk27/let-sGo/related_book_learn/Concurrency_in_go/chapter5/error_pass/err_demo/err_demo.go:65 +0x48
main.main()
  /Users/fzk27/fzk27/let-sGo/related_book_learn/Concurrency_in_go/chapter5/error_pass/err_demo/err_demo.go:87 +0x70
", Misc:map[string]interface {}{}}}
```
还有一条包含在标准输出里的消息：
```shell
...
```
在日志中我们可以看出，上面某些地方在遇到这些错误路径时处理不当，因为我们不能确定这些异常
信息是否适合用户阅读，所以我们在标准输出中打印出一个简单的异常，指出发生了意外情况。
现在我们回顾一下中间层，我们回想一下这个问题：我们为什么没有封装来自 lowlevel 模块的异常。
我们来修正一下，看看会发生什么：
```go
func runJob(id string) error {
	const jobBinPath = "/bad/job/binary"
...
```shell
[logID: 1]: 
13:02:43 main.IntermediateErr{error:main.MyError
{Inner:main.LowLevelErr{error:main.MyError{Inner:(*fs.PathError)
(0xc00006e180), Message:"stat /bad/job/binary: no such file or directory", 
StackTrace:"goroutine 1 [running]:
runtime/debug.Stack(0xc00001e090, 0x2f, 0x0)
  /Users/fzk27/.go/go1.16.6/src/runtime/debug/stack.go:24 +0x9f
main.wrapError(0x11023d0, 0xc00006e180, 0xc00001e090, 0x2f, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, ...)
  /Users/fzk27/fzk27/let-sGo/related_book_learn/Concurrency_in_go/chapter5/error_pass/err_demo_iter/err_iter.go:35 +0xb4
main.isGloballyExec(0x10e0e07, 0xf, 0x55, 0x130b748, 0x1012c1b)
  /Users/fzk27/fzk27/let-sGo/related_book_learn/Concurrency_in_go/chapter5/error_pass/err_demo_iter/err_iter.go:53 +0xc5
main.runJob(0x10df4c8, 0x1, 0x1018301, 0x0)\n
  /Users/fzk27/fzk27/let-sGo/related_book_learn/Concurrency_in_go/chapter5/error_pass/err_demo_iter/err_iter.go:70 +0x48
main.main()
  /Users/fzk27/fzk27/let-sGo/related_book_learn/Concurrency_in_go/chapter5/error_pass/err_demo_iter/err_iter.go:101 +0x70
", Misc:map[string]interface {}{}}}, Message:"cannot run job \"1\": 
requisite binaries not available", StackTrace:"goroutine 1 [running]:
runtime/debug.Stack(0x10e6bed, 0x33, 0xc00006aed8)
  /Users/fzk27/.go/go1.16.6/src/runtime/debug/stack.go:24 +0x9f
main.wrapError(0x11024f0, 0xc0000102a0, 0x10e6bed, 0x33, 0xc00006aed8, 0x1, 0x1, 0x0, 0x0, 0x0, ...)
  /Users/fzk27/fzk27/let-sGo/related_book_learn/Concurrency_in_go/chapter5/error_pass/err_demo_iter/err_iter.go:35 +0xb4
main.runJob(0x10df4c8, 0x1, 0x1018301, 0x0)
  /Users/fzk27/fzk27/let-sGo/related_book_learn/Concurrency_in_go/chapter5/error_pass/err_demo_iter/err_iter.go:73 +0x2dc
main.main()
  /Users/fzk27/fzk27/let-sGo/related_book_learn/Concurrency_in_go/chapter5/error_pass/err_demo_iter/err_iter.go:101 +0x70
", Misc:map[string]interface {}{}}}
```
...
```
有与我们使用的方法兼容的软件包（pkg/errors），不过你也可以使用任何异常软件包来实现这种异常处理方式。
你可以设计出一个 highlevel 模块的 异常处理，划分未知异和精心设计的异常，
然后逐步确认你创建的所有异常都是被精心设计的。
